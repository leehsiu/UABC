...
def draw_training_pair(image_H,psf,sf,patch_num,patch_size,image_L=None):
	...
	return patch_L,patch_H,psf_patch,px_start,py_start
...
def main():
	...
	for i in range(N_maxiter):
		...
		patch_L,patch_H,patch_psf,px_start,py_start = draw_training_pair(img_H,PSF_grid,sf,patch_num,patch_size)
		#b.	with img_L
